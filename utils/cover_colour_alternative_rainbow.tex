\begin{tikzpicture}[overlay,remember picture]
	...
	%\node[opacity=0.1,left color=white] (image) at ($(current page.south east)+(-3.3, 2.0)$) {\includegraphics[scale=2.25, angle=4,origin=c]{logo-simple}};

	\node[opacity=0.06,left color=white] (image) at ($(current page.south)+(6.50,4.0)$) {{\includegraphics[scale=11.0]{logo-simple}}};

	%\node[opacity=0.1,left color=white] (image) at ($(current page.south)+(6.50,4.0)$) {{\includegraphics[scale=11.0]{university-logo-blue}}};
	...
	{\includegraphics[scale=0.5]{university.png}}\\[1cm]
	% {\includegraphics[scale=1.8]{university-hq}}\\[1cm]
