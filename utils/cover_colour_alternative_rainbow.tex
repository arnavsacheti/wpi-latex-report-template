\begin{tikzpicture}[overlay,remember picture]
	...
	\node[opacity=.1,left color=white] (image) at ($(current page.south east)+(-3.3, 2.0)$) {\includegraphics[scale=2.25, angle=4,origin=c]{logo-simple}};
	...
	{\includegraphics[scale=0.125]{university.png}}\\
